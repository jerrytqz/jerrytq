...
const Overview = () => {
    ...
    const bodyA = 
        `I am currently a high school student in Grade 12 at Fraser Heights Secondary School. Next 
        year, I will be studying software engineering at the University of Waterloo. For as far back 
    ...
    const bodyB = 
        ...
        and science (such as by working on my newest coding project). Otherwise, I'm usually playing 
        badminton with my friends, or if it's winter, skiing on a mountain.`;

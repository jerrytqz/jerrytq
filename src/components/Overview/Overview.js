...
const OVERVIEW = [
    ...
    {
        "title": "Hobbies",
        "body": "Learning more about my favourite subjects has always filled me with joy and excitement, and as such, I can often be found studying math (especially for upcoming math competitions) and science (such as by working on my newest programming project). Otherwise, I'm usually playing badminton with my friends, or if it's winter, skiing on a mountain."
    }
]
...
const Overview = () => {
    return (
        <section className={classes.Container}>
            {OVERVIEW.map((overviewPart, index) => (
                <OverviewPart 
                    key={index} 
